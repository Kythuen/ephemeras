    ...
    ;(function (global, factory) {
        ...
        _proto.init = function init(vars) {
          ...
          var id,
            ...
            _ignoreCheck = function _ignoreCheck2(e, isPointerOrTouch) {
              return (
                ((self2.event = e) && ignore && ~ignore.indexOf(e.target)) ||
                (isPointerOrTouch &&
                  limitToTouch &&
                  e.pointerType !== 'touch') ||
            ...
            _onGestureStart = function _onGestureStart2(e) {
              return (
                ...
                onGestureStart(e, self2.isDragging)
              )
            },
            ...
            _onClick = function _onClick2(e) {
              return (
                _ignoreCheck(e) ||
                (_getEvent(e, preventDefault) && onClick(self2))
              )
            }
          onStopDelayedCall = self2._dc = gsap
      ...
      var gsap$1,
        ...
        _softRefresh = function _softRefresh2() {
          return (
            _removeListener$1(ScrollTrigger$1, 'scrollEnd', _softRefresh2) ||
            _refreshAll(true)
          )
        },
        ...
        _refresh100vh = function _refresh100vh2() {
          ...
          _100vh =
            (!_normalizer$1 && _div100vh.offsetHeight) || _win$1.innerHeight
      ...
      var ScrollTrigger$1 = (function () {
        function ScrollTrigger2(vars, animation) {
          _coreInitted$1 ||
            ScrollTrigger2.register(gsap$1) ||
        ...
        _proto.init = function init(vars, animation) {
          ...
          self2.getVelocity = function () {
            return (
              ((scrollFunc() - scroll2) / (_getTime$1() - _time2)) * 1e3 || 0
            )
          }
          ...
          self2.update = function (reset, recordVelocity, forceFake) {
            ...
            if (
              ...
              if (
                ...
                start <
                  scroll +
                    ((scroll - scroll2) / (_getTime$1() - _time2)) *
                      anticipatePin
              ) {
                clipped = 1e-4
              } else if (
            ...
            if (clipped !== prevProgress2 && self2.enabled) {
              ...
              preventOverlaps &&
                ...
                (_isFunction(preventOverlaps)
                  ...
                  : self2.getTrailing(preventOverlaps).forEach(function (t) {
          ...
          self2.enable = function (reset, refresh) {
            if (!self2.enabled) {
              ...
              onRefreshInit &&
                _addListener$1(ScrollTrigger2, 'refreshInit', onRefreshInit)
              if (reset !== false) {
          ...
          self2.disable = function (reset, allowAnimation) {
            if (self2.enabled) {
              ...
              onRefreshInit &&
                _removeListener$1(ScrollTrigger2, 'refreshInit', onRefreshInit)
              if (snapDelayedCall) {
        ...
        _getScrollNormalizer = function _getScrollNormalizer2(vars) {
          ...
          vars.onRelease = vars.onGestureStart = function (self3, wasDragging) {
            ...
            if (!wasDragging) {
              ...
              endScroll =
                currentScroll + (dur * 0.05 * -self3.velocityY) / 0.227
              dur *= _clampScrollAndGetDurationMultiplier(
                scrollFuncY,
                currentScroll,
                endScroll,
