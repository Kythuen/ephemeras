...
const TEMP_ROOT = join(homedir(), '.ephemeras/fs/Temp/ensure')
    ...
    describe('### correct params', () => {
      ...
      const cases: any = [
        ...
        },
        {
          ...
          before: () => Utils.createFile(TEST_FILE_ENSURE, 'var a = 1'),
          params: [TEST_FILE_ENSURE],
          result: {
            existBefore: true,
            existAfter: true,
        ...
        },
        {
          ...
          before: () => Utils.createDir(TEST_FOLDER_ENSURE),
          params: [TEST_FOLDER_ENSURE],
          result: {
            existBefore: true,
            existAfter: true
